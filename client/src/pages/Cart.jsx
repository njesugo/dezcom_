...
const Cart = () => {
    ...
    const makeRequest = async () => {
      try {
        const res = await userRequest.post("/checkout/payment", {
          ...
          amount: state.total, // Utilisation du total du contexte
        });
        history.push("/success", {
          stripeData: res.data,
          products: state.products, // Utilisation des produits du contexte
        });
      } catch (err) {
        console.error(err);
      }
  ...
  }, [stripeToken, state.total, history]);
        ...
        <Bottom>
          <Info>
            {state.products.map((product) => (
              <Product key={product._id}> {/* Ajout de key pour chaque produit */}
                <ProductDetail>
